...
Note the outputs of 10x Genomics cell Ranger was written to temporary storage. They may be regenerated from the fastqs using cellranger commands from *scripts/bash/data_in_brief/*
...
```{r, eval=FALSE}
aggregaation <- read.delim(here::here(
  "data/WB_CSL/outs/aggregation.csv"), sep=",")
...
write.csv(metadata, here::here(
  "data/WB_CSL/outs/metaadata.csv"
  ))
```
